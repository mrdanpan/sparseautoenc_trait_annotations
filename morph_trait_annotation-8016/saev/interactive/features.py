...
def __(mo, os):
    def make_ckpt_dropdown():
        try:
            choices = sorted(
                os.listdir("/research/nfs_su_809/workspace/XXXX-5.994/saev/features")
            )
...
def __(ckpt_dropdown, mo):
    ...
    webapp_dir = f"/research/nfs_su_809/workspace/XXXX-5.994/saev/features/{ckpt_dropdown.value}/sort_by_patch"
