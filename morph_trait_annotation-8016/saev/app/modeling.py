...
def get_model_lookup() -> dict[str, Config]:
    cfgs = [
        Config(
            ...
            "gpnn7x3p",
            pathlib.Path(
                "/research/nfs_su_809/workspace/XXXX-5.994/saev/features/gpnn7x3p-high-freq/sort_by_patch/"
            ),
            "inat21__train_mini",
            config.DataLoad(
                shard_root="/local/scratch/XXXX-5.994/cache/saev/50149a5a12c70d378dc38f1976d676239839b591cadbfc9af5c84268ac30a868",
        ...
        Config(
            ...
            "rscsjxgd",
            pathlib.Path(
                "/research/nfs_su_809/workspace/XXXX-5.994/saev/features/rscsjxgd-high-freq/sort_by_patch/"
            ),
            "inat21__train_mini",
            config.DataLoad(
                shard_root="/local/scratch/XXXX-5.994/cache/saev/07aed612e3f70b93ecff46e5a3beea7b8a779f0376dcd3bddf1d5a6ffb4c8f76",
                n_random_samples=2**16,
            ),
        ),
        Config(
            ...
            "usvhngx4",
            pathlib.Path(
                "/research/nfs_su_809/workspace/XXXX-5.994/saev/features/usvhngx4-high-freq/sort_by_patch/"
            ),
            "imagenet__train",
            config.DataLoad(
                shard_root="/local/scratch/XXXX-5.994/cache/saev/ac89246f1934b45e2f0487298aebe36ad998b6bd252d880c0c9ec5de78d793c8",
                n_random_samples=2**16,
            ),
        ),
        Config(
            ...
            "oebd6e6i",
            pathlib.Path(
                "/research/nfs_su_809/workspace/XXXX-5.994/saev/features/oebd6e6i/sort_by_patch/"
            ),
            "imagenet__train",
            config.DataLoad(
                shard_root="/local/scratch/XXXX-5.994/cache/saev/724b1b7be995ef7212d64640fec2885737a706a33b8e5a18f7f323223bd43af1",
                n_random_samples=2**16,
            ),
        ),
    ]
